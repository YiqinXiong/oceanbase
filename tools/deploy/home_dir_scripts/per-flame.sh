...
COM1="perf record -o perf-flame-new.data -F 99 -g -p $PID -- sleep $1"
COM2="perf script -i ~/perf-flame-new.data > ~/perf-flame-new.viz"
echo $COM1
eval $COM1
echo $COM2
eval $COM2

echo "check result: http://$(hostname -i):39411/perf-flame-new.viz"
